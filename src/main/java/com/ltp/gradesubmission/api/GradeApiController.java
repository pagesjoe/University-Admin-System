...
public class GradeApiController {
    ...
    public ResponseEntity<Grade> saveGrade(@RequestBody Grade grade, @PathVariable int studentId,
        @PathVariable int courseId) {
        return new ResponseEntity<>(gradeService.saveGrade(grade, studentId, courseId), HttpStatus.CREATED);
    }

    @PutMapping("/student/{studentId}/course/{courseId}")
    public ResponseEntity<Grade> updateGrade(@RequestBody Grade grade, @PathVariable int studentId, @PathVariable int courseId) {
